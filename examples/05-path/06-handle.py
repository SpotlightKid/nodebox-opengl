...
def draw(canvas):
    ...
    for i, pt in enumerate(p):
        if i > 0:
            ...
            line(p[i-1].x, p[i-1].y, pt.ctrl1.x, pt.ctrl1.y, strokestyle=STROKE_DASHED)
        ...
        or pt.ctrl2.y != pt.y:
            ...
            line(pt.x, pt.y, pt.ctrl2.x, pt.ctrl2.y, strokestyle=STROKE_DASHED)
    ...
    pt = p.point(t)
    ellipse(pt.x, pt.y, 4, 4)
    line(pt.x, pt.y, pt.ctrl1.x, pt.ctrl1.y, strokestyle=STROKE_DASHED)
    line(pt.x, pt.y, pt.ctrl2.x, pt.ctrl2.y, strokestyle=STROKE_DASHED)

...
# Since this is a relatively slow operation, this is not useful for dynamic
# image processing, but there a various other ways in which pixels can be
# useful. In short:
...
# - Pixels.update() commits all the changes. You can then pass Pixels to the
#   image() command.
